...
(module+ test
  ...
  (test-case "generators: seeded streams replay and continue"
    ...
    (check-equal? (dtype (randperm 4)) 'int64)
    (check-equal? (shape (randperm 0)) '(0))
    ...
    (check-equal? (shape (randperm 3 #:generator #f)) '(3)
