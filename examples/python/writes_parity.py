...
forms.append(form(t))
t = fresh(); t[t > 4] = torch.tensor([[9.0, 10.0]]); forms.append(form(t))
t = fresh(); t[t > 4] = torch.tensor([[[7.0]]]); forms.append(form(t))
t = fresh(); t[:, 0] = torch.tensor([[8.0, 9.0]]); forms.append(form(t))
t = fresh(); t[0] = torch.tensor([[[7.0, 8.0, 9.0]]]); forms.append(form(t))
